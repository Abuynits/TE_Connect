...
TIME_ENC_DROP = 0.1
TIME_DEC_DROP = 0.1
TIME_ENC_DIM_VAL = 512
TIME_ENC_HEAD_COUNT = 4
TIME_ENC_LAYER_COUNT = 4
TIME_VERBOSE = False

TIME_DEC_DIM_VAL = 512
TIME_DEC_HEAD_COUNT = 4
TIME_DEC_LAYER_COUNT = 4
TIME_DEC_DIM_FEED_FORWARD = 2048
TIME_ENC_DIM_FEED_FORWARD = 2048
